...
public abstract class TimeUtils {
	...
	/**
	 * 把字符串转化成Date对象
	 * @param dateStr 日期字符串，格式必须是yyyyMMddHHmmss
	 * @return
	 */
	public static Date getDate1(String dateStr) {
		...
		try {
			date = mSimpleDateFormat_1.parse(dateStr);
			return date;
	...
	/**
	 * 把字符串转化成Date对象
	 * @param dateStr 日期字符串，格式必须是yyyyMMddHHmmssS
	 * @return
	 */
	public static Date getDate2(String dateStr) {
		...
		try {
			date = mSimpleDateFormat_2.parse(dateStr);
			return date;
		} catch (ParseException e) {
			e.printStackTrace();
	...
	public static Date getDate3(String dateStr) {
		...
		try {
			date = mSimpleDateFormat_3.parse(dateStr);
			return date;
		} catch (ParseException e) {
			e.printStackTrace();
	...
	/**
	 * 把字符串转化成Date对象
	 * @param dateStr 日期字符串，格式必须是yyyyMMdd
	 * @return
	 */
	public static Date getDate4(String dateStr) {
		Date date = new Date();
		if (TextUtils.isEmpty(dateStr)) {
			return date;
		}
		try {
			date = mSimpleDateFormat_4.parse(dateStr);
			return date;
		} catch (ParseException e) {
			e.printStackTrace();
