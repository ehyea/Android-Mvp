...
public class SharedPreferencesUtils {
    ...
    public static <T> void setDataList(String key, List<T> datalist) {
        ...
        SharedPreferencesUtils.putString(AppUtils.getContext(), key, strJson);
    }
    ...
    public static <T> List<T> getDataList(String key, Class<T> cls) {
        ...
        String strJson = SharedPreferencesUtils.getString(AppUtils.getContext(), key, null);
